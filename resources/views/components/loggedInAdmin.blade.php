...
<div class="w-full h-full">
  ...
  <div class="flex justify-between">
    ...
    <div class="kanan flex " style="align-items: center;">
      ...
      <button type="button" class="flex text-sm rounded-full md:mr-0 pl-6" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r">
      <div class="flex flex-col justify-between flex-1 mt-6">
        <nav>
          ...
          <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="/create-blog/Article">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
