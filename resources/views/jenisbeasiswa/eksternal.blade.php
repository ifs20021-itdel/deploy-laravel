...
@section('content')
<h1 class="text-center font-bold text-3xl pt-1 text-white mt-5" style="color: #0D285F;">Jenis Beasiswa</h1>
<h1 class="text-center font-bold text-3xl pt-1 text-white mb-5 " style="color: #0D285F;">Eksternal</h1>
...
<div id="carouselExampleControls" class="relative" data-te-carousel-init data-te-carousel-slide>
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
        ...
        <div class="relative float-left -mr-[100%] w-full transition-transform duration-[600ms] ease-in-out motion-reduce:transition-none" data-te-carousel-item data-te-carousel-active>
            <img src="https://upload.wikimedia.org/wikipedia/commons/2/2c/IT_Del_Drone2.jpg" class="block w-full" alt="Wild Landscape" />
        </div>
        <!--Second item-->
...
<div class="container w-4/4 m-auto px-10 pb-20">
