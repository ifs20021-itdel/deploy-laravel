  ...
  <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadowm m-2">
        <div class="grid grid-cols-1">
          ...
          <div class="px-3 mx-1">
            ...
            <a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-[#F49D1A] dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="submit">
              Read more
